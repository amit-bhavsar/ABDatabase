#
#  Be sure to run `pod spec lint ABDatabase.podspec' to ensure this is a
...
Easy wrapper for SQLite which simplify the SQL query into easy to remember methods and its argument.
  ...
  s.homepage     = "https://github.com/AmitBhavsarIphone/ABDatabase"
  ...
  s.author             = { "Amit Bhavsar" => "amitbhavsar@live.com" }
